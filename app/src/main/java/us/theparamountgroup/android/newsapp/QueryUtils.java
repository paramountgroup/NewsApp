...
public final class QueryUtils {
    ...
    public static List<Article> fetchArticleData(String requestUrl) {
        ...
        try {
            ...
            //   Log.i(LOG_TAG,"JSON response from the Guardian: " + jsonResponse);
        } catch (IOException e) {
    ...
    private static List<Article> extractFeatureFromJson(String earthquakeJSON) {
        ...
        try {
            ...
            //declare formatted Date and iconLetter
            ...
            // For each article in the article Array, create an {@link Article} object
            for (int i = 0; i < articleArray.length(); i++) {
                ...
                StringBuilder sb = new StringBuilder(currentArticle.getString("webPublicationDate"));
                ...
                try {
                    ...
                    Log.i(LOG_TAG, "did not parse dateString:) ");
                    e.printStackTrace();
                }

                Article article = new Article(formattedDate, webTitle, sectionName, url, iconLetter);
